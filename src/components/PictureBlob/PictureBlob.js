  ...
  return (
    <div className={classes.pictureContainer}>
      ...
      <div className={classes.blobContainer}>
        ...
        <svg svg className={`${classes.imageBlob}`} viewBox={`0 0 ${blobSize} ${blobSize}`} xmlns="http://www.w3.org/2000/svg">
          <defs>
          ...
          <image width={blobSize * 0.7} height={blobSize * 0.7} xlinkHref={aboutPic} clip-path="url(#myCircle)" transform="translate(30 30)" />
        </svg>
      </div>
    </div >
  );
